...
public class SimpleMqttClient : IDisposable
{
    ...
    /// </summary>
    /// <param name="clientId">MijnRobot</param>
    /// <returns></returns>
    public static SimpleMqttClient CreateSimpleMqttClientForHiveMQ(string clientId)
    {
        var mqttWrapper = new SimpleMqttClient(new()
        {
            Host = "380bf97fc688479398b7cedbfffe6045.s1.eu.hivemq.cloud", // maak eventueel een account aan bij hivemq als dit problemen geeft.
            Port = 8883,
            ...
            UserName = "hivemq.webclient.1732705714638",
            Password = "B5607SRHaCcTfbdg&:?;"
        });
